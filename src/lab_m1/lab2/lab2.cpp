...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<unsigned int> indices =
        {
            ...
            1, 2, 4,    // indices for second triangle
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1)), // 0
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)), // 1
            VertexFormat(glm::vec3(0, 0, -1), glm::vec3(1, 1, 1)), // 2
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 0)), // 3
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0)), // 4
        };
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)), // 1
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 1, 1)), // 2
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 1, 0)), // 3
        };
    ...
    // bonus
    {
        ...
        {
            // face 1
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 0)), // 0
            VertexFormat(glm::vec3(0, 0, -1), glm::vec3(0, 1, 0)), // 1
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0)), // 2

            // face 2
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0)), // 3
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 0)), // 4
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0)), // 5

            // face 3
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 0, 1)), // 6
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 1)), // 7
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0, 1)), // 8

            // face 4
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0)), // 9
            VertexFormat(glm::vec3(0, 0, -1), glm::vec3(1, 1, 0)), // 10
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 1, 0)), // 11

            // bottom face
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1)), // 12
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1)), // 13
            VertexFormat(glm::vec3(0, 0, -1), glm::vec3(0, 1, 1)), // 14
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1)), // 15
        };
        ...
        CreateMesh("pyramid_bonus", vertices, indices);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1.5f, 2, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["pyramid"], shaders["VertexColor"], glm::vec3(-4, 0, 0), glm::vec3(1));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 3, 0), glm::vec3(1));

    // bonus
    RenderMesh(meshes["pyramid_bonus"], shaders["VertexColor"], glm::vec3(-4, 2, 0), glm::vec3(1));
